...
interface SecureFileUploadComponentProps {
  maxSizeInMB?: number;
  maxFiles?: number;
...
const SecureFileUploadComponent: React.FC<SecureFileUploadComponentProps> = ({
  maxSizeInMB = 5,
  maxFiles = 5,
...
export default SecureFileUploadComponent;
