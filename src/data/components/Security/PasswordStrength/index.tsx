...
const PasswordStrengthComponentItem: ComponentItem = {
  id: 302,
  name: "Password Strength Meter",
  description: "A secure password input with real-time strength validation and requirements checklist",
  category: "Security",
...
export const PasswordStrength: React.FC<PasswordStrengthProps> = ({
  ...
  framework: "React",
  isNew: true,
  tags: ["security", "password", "validation", "form", "input", "meter", "strength"],
  fileSize: "4.2kb",
  complexity: "medium",
...
export default PasswordStrengthComponentItem;
