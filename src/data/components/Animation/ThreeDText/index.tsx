...
import AnimatedText3D from './ThreeDTextComponent';

const ThreeDTextComponentItem: ComponentItem = {
  id: 105,
  name: "3D Text Animation",
  description: "Interactive 3D text with hover and click effects, perfect for headlines and logos",
  category: "Animation",
  framework: "React",
  language: "TypeScript",
  tags: ["3D", "Text", "Interactive", "Three.js", "Hover Effects"],
  isNew: true,
  is3D: true,
  component: () => <AnimatedText3D />,
...
export default ThreeDTextComponentItem;
