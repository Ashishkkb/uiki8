...
import ParticleButton from './ParticleButtonComponent';
import { Zap, Star, ArrowUp } from 'lucide-react';

const ParticleButtonComponentItem: ComponentItem = {
  id: 107,
  name: "Particle Button Animation",
  description: "Interactive button with explosive particle effects when clicked",
  category: "Animation",
  framework: "React",
  language: "TypeScript",
  tags: ["Button", "Interactive", "Particles", "Click Effect", "Motion"],
  isNew: true,
  component: () => (
...
import { Sparkles, Zap, Star, ArrowUp } from 'lucide-react';
...
// Demo component showcasing different button variations
const ParticleButtonDemo = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-8 py-12">
      <ParticleButton 
        text="Click for Magic" 
...
export default ParticleButtonDemo;`
};

export default ParticleButtonComponentItem;
