...
import MediaCarousel from './MediaCarouselComponent';

const MediaCarouselComponentItem: ComponentItem = {
  id: 109,
  name: "Media Carousel with Effects",
  description: "Advanced carousel that supports both images and videos with multiple animation effects and transitions",
  category: "Media",
  framework: "React",
  language: "TypeScript",
  tags: ["Carousel", "Images", "Video", "Animation", "Effects"],
  isNew: true,
...
export default MediaCarouselComponentItem;
