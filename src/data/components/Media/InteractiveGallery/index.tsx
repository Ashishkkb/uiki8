...
import InteractiveGallery from './InteractiveGalleryComponent';

const InteractiveGalleryComponentItem: ComponentItem = {
  id: 108,
  name: "Interactive Image Gallery",
  description: "Feature-rich image gallery with lightbox, filtering, and multiple layout options",
  category: "Media",
  framework: "React",
  language: "TypeScript",
  tags: ["Gallery", "Images", "Interactive", "Lightbox", "Filtering"],
  isNew: true,
...
export default InteractiveGalleryComponentItem;
