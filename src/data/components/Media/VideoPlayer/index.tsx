...
const VideoPlayerComponentItem: ComponentItem = {
  id: 110,
  name: "Video Player with Annotations",
  description: "Advanced video player with timeline markers, annotations, and support for custom themes",
  category: "Media",
  framework: "React",
  language: "TypeScript",
  tags: ["Video", "Player", "Annotations", "Controls", "Timeline"],
  isNew: true,
...
export default VideoPlayerComponentItem;
