...
const DataGridComponentItem: ComponentItem = {
  id: 136,
  name: "Data Grid",
  category: "Data Display",
  framework: "React",
  description: "A versatile data grid component with sorting, pagination, and custom cell rendering.",
  component: DataGridComponent,
  price: "Free",
  language: "TypeScript",
  tags: ["table", "grid", "data", "display", "pagination"],
  isNew: true,
  fileSize: "3.6kb",
  complexity: "medium",
...
export default DataGridComponentItem;
