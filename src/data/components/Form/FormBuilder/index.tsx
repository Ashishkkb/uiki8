...
const FormBuilderComponent: ComponentItem = {
  id: 402,
  name: "Form Builder",
  category: "Form",
  framework: "React",
  description: "A dynamic form builder component with validation and multiple field types",
...
export default FormBuilder;`,
      ...
      <FormBuilder
        fields={[
          ...
          },
          {
            id: "subscribe",
            name: "subscribe",
            label: "I want to receive updates about products and features",
            type: "checkbox"
          }
        ]}
  ...
  tags: ["form", "builder", "dynamic", "validation"],
  fileSize: "6.8 KB",
  price: "Free",
  isNew: true
};
