...
const VirtualKeyboardComponentItem: ComponentItem = {
  id: 154,
  name: "Virtual Keyboard",
  description: "Customizable on-screen keyboard with multiple layouts, themes, and input capabilities",
  category: "Form",
  framework: "React",
  language: "TypeScript",
  tags: ["Keyboard", "Input", "Form", "Accessibility", "Touch"],
  isNew: true,
  component: () => (
    <div className="max-w-xl mx-auto space-y-8">
      {/* Default keyboard with input field */}
      <div>
        <h3 className="text-lg font-medium mb-2">Standard Keyboard</h3>
        <VirtualKeyboard 
          layout="standard"
          darkMode={false}
          theme="default"
      ...
      {/* Dark mode keyboard with layout selector */}
      <div>
        <h3 className="text-lg font-medium mb-2">Interactive Keyboard (Dark Mode)</h3>
        <VirtualKeyboard 
          layout="standard"
          darkMode={true}
          ...
          animateKeys={true}
          inputPlaceholder="Try different layouts and languages..."
          onChange={(value) => console.log('Value changed:', value)}
        />
      </div>
      ...
      {/* Phone keyboard */}
      <div>
        <h3 className="text-lg font-medium mb-2">Phone Keyboard</h3>
        <VirtualKeyboard 
          layout="phone"
          showTooltips={true}
          onChange={(value) => console.log('Value changed:', value)}
      ...
      {/* Emoji keyboard */}
      <div>
        <h3 className="text-lg font-medium mb-2">Emoji Keyboard</h3>
        <VirtualKeyboard 
          layout="emoji"
          showCloseButton={true}
          onChange={(value) => console.log('Value changed:', value)}
...
export default VirtualKeyboardComponentItem;
