...
const InputNumberComponentItem: ComponentItem = {
  id: 130,
  name: "Input Number",
  category: "Form",
  framework: "React",
  description: "An input component specialized for numerical values with increment/decrement controls and validation.",
...
export default InputNumber;`,
  ...
  tags: ["Form", "input", "number", "spinner"],
  isNew: true,
  fileSize: "3.5 KB",
  complexity: "medium"
};

export default InputNumberComponentItem;
