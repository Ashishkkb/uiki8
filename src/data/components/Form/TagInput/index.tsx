...
const TagInputComponentItem: ComponentItem = {
  id: 44,
  name: "Tag Input",
  category: "Form",
  framework: "React",
  description: "A form input for collecting multiple tags or keywords with keyboard navigation support.",
  component: TagInputComponent,
  price: "Free",
  language: "TypeScript",
  previewBg: "light",
  tags: ["form", "input", "tags", "tokens", "keywords"],
  isNew: true,
  fileSize: "3.5kb",
  complexity: "medium",
...
export default TagInputComponentItem;
