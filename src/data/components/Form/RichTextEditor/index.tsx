...
<p>This is a <b>rich text editor</b> with support for basic formatting options like <i>italics</i>, <u>underline</u>, and <s>strikethrough</s>.</p>
<p>You can also:</p>
<ul>
  <li>Create bulleted lists</li>
  <li>Add links</li>
  <li>Insert images</li>
  <li>Format text with headings</li>
</ul>
<blockquote>This is a blockquote for important text that stands out.</blockquote>
<p>Try editing this content to see how the editor works!</p>
`;

const RichTextEditorComponentItem: ComponentItem = {
  id: 155,
  name: "Rich Text Editor",
  description: "WYSIWYG editor with formatting controls, image insertion, and text styling options",
  category: "Form",
  framework: "React",
  language: "TypeScript",
  tags: ["Editor", "WYSIWYG", "Text", "Form", "Content"],
  isNew: true,
  component: () => (
...
export default RichTextEditorComponentItem;
