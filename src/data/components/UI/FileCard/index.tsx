...
const FileCardComponentItem: ComponentItem = {
  id: 106,
  name: "File Card",
  category: "UI",
  framework: "React",
  description: "A component for displaying file information with preview, download, and delete capabilities.",
...
const FileCard: React.FC<FileCardProps> = ({
  ...
  const getFileIcon = () => {
    switch (file.type) {
      ...
      case 'pdf':
        return <FilePdfIcon className="h-full w-full" />;
      default:
...
export default FileCard;`,
  ...
  tags: ["UI", "file", "document", "media"],
  isNew: true,
  fileSize: "3.8 KB",
  complexity: "medium"
};

export default FileCardComponentItem;
