...
const CookieConsentComponentItem: ComponentItem = {
  id: 201,
  name: "Cookie Consent",
  description: "A GDPR-compliant cookie consent banner with customizable preferences and detailed privacy options",
  category: "UI",
...
export const CookieConsent = () => {
  ...
  framework: "React",
  isNew: true,
  tags: ["ui", "cookies", "gdpr", "consent", "privacy", "security"]
};
