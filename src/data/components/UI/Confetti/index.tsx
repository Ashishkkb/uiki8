...
const ConfettiComponentItem: ComponentItem = {
  id: 104,
  name: "Confetti",
  category: "UI",
  framework: "React",
  description: "A celebratory confetti effect component to add excitement to achievement moments.",
...
export default Confetti;`,
  ...
  tags: ["UI", "animation", "celebration", "effects"],
  isNew: true,
  fileSize: "3.3 KB",
  complexity: "medium"
};

export default ConfettiComponentItem;
