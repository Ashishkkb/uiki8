...
import GradientButtonComponent from "./GradientButtonComponent";

const GradientButtonComponentItem: ComponentItem = {
  id: 115,
  name: "Gradient Button",
  category: "UI",
  framework: "React",
  description: "A button component with customizable gradient backgrounds, animation effects, and loading states.",
...
export default GradientButton;`,
  ...
  tags: ["UI", "button", "gradient", "interactive"],
  isNew: true,
  fileSize: "4.0 KB",
  complexity: "medium"
};

export default GradientButtonComponentItem;
