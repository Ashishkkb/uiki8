...
const ProgressBarComponentItem: ComponentItem = {
  id: 120,
  name: "Progress Bar",
  category: "UI",
  framework: "React",
  description: "A highly customizable progress bar component with animations, striped effects, and various styling options.",
...
export default ProgressBar;`,
  ...
  tags: ["UI", "progress", "loading", "feedback"],
  isNew: true,
  fileSize: "2.5 KB",
  complexity: "medium"
};

export default ProgressBarComponentItem;
