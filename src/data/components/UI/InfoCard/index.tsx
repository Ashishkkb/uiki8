...
const InfoCardComponentItem: ComponentItem = {
  id: 63,
  name: "Info Card",
  category: "UI",
  framework: "React",
  description: "A card component designed to display information with an optional icon and various visual styles.",
  component: InfoCardComponent,
  price: "Free",
  language: "TypeScript",
  previewBg: "light",
  tags: ["UI", "card", "info", "status", "display"],
  isNew: true,
  fileSize: "1.7kb",
  complexity: "simple",
...
export default InfoCardComponentItem;
