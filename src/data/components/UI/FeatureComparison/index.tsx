...
import FeatureComparisonComponent from "./FeatureComparisonComponent";

const FeatureComparisonComponentItem: ComponentItem = {
  id: 110,
  name: "Feature Comparison",
  category: "UI",
  framework: "React",
  description: "A component for displaying feature comparisons across different pricing plans or product tiers.",
...
export default FeatureComparison;`,
  ...
  tags: ["UI", "comparison", "pricing", "table"],
  isNew: true,
  fileSize: "3.9 KB",
  complexity: "medium"
};

export default FeatureComparisonComponentItem;
