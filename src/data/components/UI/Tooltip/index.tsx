...
const TooltipComponent: ComponentItem = {
  id: 205,
  name: "Tooltip",
  category: "UI",
  framework: "React",
  description: "A customizable tooltip component that provides additional context and information on hover",
