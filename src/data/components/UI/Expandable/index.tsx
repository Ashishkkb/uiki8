...
const ExpandableComponentItem: ComponentItem = {
  id: 105,
  name: "Expandable",
  category: "UI",
  framework: "React",
  description: "A flexible expandable/collapsible component for revealing and hiding content.",
...
export default Expandable;`,
  ...
  tags: ["UI", "disclosure", "accordion", "expandable"],
  isNew: true,
  fileSize: "3.0 KB",
  complexity: "medium"
};

export default ExpandableComponentItem;
