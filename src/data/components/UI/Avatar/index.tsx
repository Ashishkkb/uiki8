...
const AvatarComponent: ComponentItem = {
  id: 206,
  name: "Avatar",
  category: "UI",
  framework: "React",
  description: "A versatile avatar component for displaying user images with fallback, status indicators, and multiple display options",
