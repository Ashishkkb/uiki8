...
const BreadcrumbComponentItem: ComponentItem = {
  id: 101,
  name: "Breadcrumb",
  category: "UI",
  framework: "React",
  description: "A breadcrumb navigation component to display hierarchical paths with custom separators and icons.",
...
export default Breadcrumb;`,
  ...
  tags: ["UI", "navigation", "breadcrumb", "path"],
  isNew: true,
  fileSize: "1.8 KB",
  complexity: "simple"
};

export default BreadcrumbComponentItem;
