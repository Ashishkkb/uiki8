...
import WeatherWidget from './WeatherWidgetComponent';

const WeatherWidgetComponentItem: ComponentItem = {
  id: 150,
  name: "Weather Widget",
  description: "Interactive weather widget with city search, current conditions, and 5-day forecast",
  category: "UI",
  framework: "React",
  language: "TypeScript",
  tags: ["Weather", "Forecast", "Widget", "Search", "UI"],
  isNew: true,
  component: () => (
    <div className="max-w-md mx-auto">
      <WeatherWidget defaultCity="New York" showSearch={true} showForecast={true} theme="light" />
    </div>
  ),
...
export default WeatherWidgetComponentItem;
