...
const ToastComponent: ComponentItem = {
  id: 204,
  name: "Toast",
  category: "UI",
  framework: "React",
  description: "A customizable toast notification system for providing feedback and displaying important information to users",
...
export default ToastPreview;`,
  ...
  tags: ["UI", "notification", "feedback", "alert"],
  isNew: true,
  fileSize: "2.1 KB",
  price: "Free"
};
