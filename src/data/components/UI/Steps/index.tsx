...
const StepsComponentItem: ComponentItem = {
  id: 102,
  name: "Steps",
  category: "UI",
  framework: "React",
  description: "A versatile steps component for displaying multi-step processes with various orientations and styles.",
...
export default Steps;`,
  ...
  tags: ["UI", "navigation", "steps", "multi-step"],
  isNew: true,
  fileSize: "2.4 KB",
  complexity: "medium"
};

export default StepsComponentItem;
