...
const VerificationCodeComponentItem: ComponentItem = {
  id: 109,
  name: "Verification Code",
  category: "UI",
  framework: "React",
  description: "A component for entering verification codes, one-time passwords, and PIN numbers.",
...
export default VerificationCode;`,
  ...
  tags: ["UI", "form", "authentication", "OTP"],
  isNew: true,
  fileSize: "3.8 KB",
  complexity: "medium"
};

export default VerificationCodeComponentItem;
